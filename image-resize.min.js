...
var DisplaySize = function (_BaseModule) {
    ...
    function DisplaySize() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DisplaySize.__proto__ || Object.getPrototypeOf(DisplaySize)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
             ...
             */
            var self = _this;
            _this.inputWidth = document.createElement('input');
            _this.inputWidth.type = 'number';
            _this.inputWidth.placeholder = 'Ширина';
            _this.inputWidth.value = _this.img.width;
            _this.inputWidth.classList.add('image-modal__input-width');
            _this.inputWidth.addEventListener('keydown', function (e) {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    e.stopPropagation();
            ...
            _this.overlay.appendChild(_this.inputWidth);
    ...
    function Resize() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Resize.__proto__ || Object.getPrototypeOf(Resize)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
            ...
            if (_this.dragBox === _this.boxes[0] || _this.dragBox === _this.boxes[3]) {
                ...
                if (Math.round(_this.preDragWidth - deltaX) >= 200) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icon_alt_svg__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icon_alt_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__icon_alt_svg__);
...
var Toolbar = function (_BaseModule) {
	...
	function Toolbar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
			...
			_this.alignments.forEach(function (alignment, idx) {
				...
				button.addEventListener('click', function () {
					...
					if (alignment.isApplied()) {
						...
						_this._selectButton(button, idx);
						alignment.apply();
					}
			...
			_this._addWideCheckbox();
		}, _this._addWideCheckbox = function () {
			var self = _this;

			/**
    * Add button to call modal;
    */
			var callModalButton = document.createElement('button');
    ...
    */
			_this.toolbar.appendChild(callModalButton);
			...
			// ALT
			var modalInputAltWrapper = document.createElement('div');
			modalInputAltWrapper.classList.add('image-modal__form-group');
			var modalInputAltLabel = document.createElement('label');
			modalInputAltLabel.textContent = 'ALT текст:';
			modalInputAltLabel.setAttribute('for', 'js-image-modal-alt-text');
			var modalInputAlt = document.createElement('input');
			modalInputAlt.type = 'text';
			modalInputAlt.value = _this.img.alt;
			...
			// Description
			var modalInputDescriptionWrapper = document.createElement('div');
			modalInputDescriptionWrapper.classList.add('image-modal__form-group');
			var modalInputDescriptionLabel = document.createElement('label');
			...
			var modalInputDescriptionTextarea = document.createElement('textarea');
			modalInputDescriptionTextarea.value = _this.img.getAttribute('data-description');
			...
			// Wide
			var modalWideCheckboxWrapper = document.createElement('div');
			modalWideCheckboxWrapper.classList.add('image-modal__form-group');
			var modalWideCheckboxLabel = document.createElement('label');
			modalWideCheckboxLabel.textContent = 'Широкоформатное изображения:';
			var modalWideCheckbox = document.createElement('input');
			modalWideCheckbox.id = 'js-image-modal-wide-checkbox';
			modalWideCheckbox.type = 'checkbox';
			if (_this.img.classList.contains('is-wide')) {
				modalWideCheckbox.checked = true;
			}
			var modalWideCheckboxInputLabel = document.createElement('label');
			...
			// Save button
			var modalButtonSave = document.createElement('button');
    ...
    */
			modalButtonSave.addEventListener('click', function () {
				self._saveModalChanges(modalInputAlt.value, modalInputDescriptionTextarea.value, modalWideCheckbox.checked, modal);
			});
		}, _this._saveModalChanges = function (altText, descriptionText, isWide, modal) {
			_this.img.alt = altText;
			_this.img.setAttribute('data-description', descriptionText);
			if (isWide) {
				_this.img.classList.add('is-wide');
			} else {
				_this.img.classList.remove('is-wide');
			}
			document.querySelector('body').removeChild(modal);
		}, _this._selectButton = function (button, idx) {
			if (idx && idx !== 3) {
...
var ImageResize = function ImageResize(quill) {
    ...
    this.initializeModules = function () {
        ...
        window._hideOverlay = _this.hide;
    };
