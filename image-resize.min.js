...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icon_alt_svg__ = __webpack_require__(110);
	...
	function Toolbar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
			...
			_this.alignments = [{
				...
				icon: __WEBPACK_IMPORTED_MODULE_3__icon_alt_svg___default.a,
				apply: function apply() {
					var alt = prompt('Введите ALT атрибут для изображения:', _this.img.alt);
					if (alt === null) {
						return false;
					} else {
						_this.img.alt = alt;
